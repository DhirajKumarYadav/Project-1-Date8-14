                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <form action="subscriber" method="post">
                            ...
                            <div class="form-group">
                                    <label>Name</label>
                                    <input class="form-control border-0 py-4" type="text" name="name" placeholder="Your Name">
                                </div>
                            <div class="form-group">
                                    <label>Email Address</label>
                                    <input class="form-control border-0 py-4" type="email" name="email" placeholder="Email" >
                                </div>
                            <div>
